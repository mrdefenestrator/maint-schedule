...
class TestRule:
    ...
    def test_base_key_strips_phase(self):
        ...
        rule = Rule(
            item="engine coolant", verb="replace", phase="ongoing", interval_miles=75000
        )
    ...
    def test_is_active_at_with_start(self):
        ...
        rule = Rule(
            item="coolant", verb="replace", interval_miles=75000, start_miles=137500
        )
    ...
    def test_is_active_at_with_stop(self):
        ...
        rule = Rule(
            item="coolant", verb="replace", interval_miles=137500, stop_miles=137500
        )
        assert rule.is_active_at(0)
