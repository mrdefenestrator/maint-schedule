...
def status_color(status: Status) -> str:
    ...
    colors = {
        Status.OVERDUE: "bg-red-100 text-red-800 border-red-200 dark:bg-red-900/30 dark:text-red-300 dark:border-red-900",
        Status.DUE_SOON: "bg-yellow-100 text-yellow-800 border-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-900",
        Status.OK: "bg-green-100 text-green-800 border-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-900",
        Status.INACTIVE: "bg-gray-100 text-gray-500 border-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700",
        Status.UNKNOWN: "bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900/30 dark:text-purple-300 dark:border-purple-900",
    }
    return colors.get(
...
def add_rule_view(vehicle_id: str):
    ...
    counts_as = [v.strip() for v in counts_as_raw.split(",") if v.strip()] if counts_as_raw else []
